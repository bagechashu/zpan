...
func InitializeServer() *Server {
	...
	cloudStorageScanner := storage.NewCloudStorageScanner(storageDBQuery, matterDBQuery, cloudStorage)
	storageResource := api.NewStorageResource(storageDBQuery, cloudStorage, cloudStorageScanner)
